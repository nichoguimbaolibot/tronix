...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Tronix online Shopping cart</title>
...
<!-- Sidebar ================================================== -->
	...
	<div class="row">
		<div class="span4">
			...
			Cliiiick heeere to create an account.<br/><br/><br/>
			<form action="registeran.php">
			  <div class="controls">
		...
		<div class="span4">
			...
			<form action="loginaction.php" method="post">
			  <div class="control-group">
				...
				<div class="controls">
				  <input class="span3"  type="text" id="email1" placeholder="Email" name="email1">
				</div>
			  </div>
			  <div class="control-group">
				<label class="control-label" for="inputPassword1">Password</label>
				<div class="controls">
				  <input type="password" class="span3"  id="pass1" placeholder="Password" name="pass1">
				</div>
			  </div>
			  <div class="control-group">
				<div class="controls">
				  <button type="submit" class="btn" name="login">Sign in</button> <a href="forgetpass.php">Forget password?</a>
				</div>
			  </div>
			</form>
		</div>
