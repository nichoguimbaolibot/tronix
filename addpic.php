...
<!-- Sidebar end=============================================== -->
	...
	<div class="alert fade in">
	 ...
	 <div class="alert alert-block alert-error fade in">
		...
		<strong>Lorem Ipsum is simply</strong> dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s
	 	...
	 	<form class="form-horizontal"  action="uploadpic1.php" method="post" enctype="multipart/form-data">
	...
	<div class="control-group">
	  	...
	  	<label class="control-label" for="quantity">Upload Image<sup>*</sup></label>
		<div class="controls">
    	<input enctype="multipart/form-data" type="file" name="name">
		</div>
	  	</div>
