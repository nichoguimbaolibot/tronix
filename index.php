...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide">
		<div class="carousel-inner">
		  ...
		  <div class="container">
			<a href="special_offer.php"><img style="width:100%" src="themes/images/carousel/1.png" alt="special offers"/></a>
		  ...
		  <div class="item">
		  <div class="container">
			<a href="special_offer.php"><img style="width:100%" src="themes/images/carousel/2.png" alt=""/></a>
				<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
		  ...
		  <div class="item">
		  <div class="container">
			<a href="special_offer.php"><img src="themes/images/carousel/3.png" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
		   ...
		   <div class="item">
		   <div class="container">
			<a href="special_offer.php"><img src="themes/images/carousel/4.png" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
		   ...
		   <div class="item">
		   <div class="container">
			<a href="special_offer.php"><img src="themes/images/carousel/5.png" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
			</div>
		   ...
		   <div class="item">
		   <div class="container">
			<a href="special_offer.php"><img src="themes/images/carousel/6.png" alt=""/></a>
			<div class="carousel-caption">
				  <h4>Second Thumbnail label</h4>
				  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
				</div>
...
<!-- Sidebar end=============================================== -->
		<div class="span9">		
			...
			<h4>Featured Products <small class="pull-right">20+ featured products</small></h4>
			<div class="row-fluid">
			  ...
			  <ul class="thumbnails">
				<li class="span3">
				  ...
				  <i class="tag"></i>
					...
					<div class="caption">
					  <h5>TCS34725 RGB Sensor</h5>
					  <h4><a class="btn" href="product_details.php">VIEW</a> <span class="pull-right">P722.00</span></h4>
					</div>
				  </div>
				</li>
				<li class="span3">
				  ...
				  <i class="tag"></i>
					...
					<div class="caption">
					  <h5>L298H Motor Driver</h5>
					  <h4><a class="btn" href="product_details.php">VIEW</a> <span class="pull-right">P552.00</span></h4>
					</div>
				  </div>
				</li>
				<li class="span3">
				  ...
				  <i class="tag"></i>
					...
					<div class="caption">
					  <h5>RGB sensor using LED</h5>
					   <h4><a class="btn" href="product_details.php">VIEW</a> <span class="pull-right">P322.00</span></h4>
					</div>
				  </div>
				</li>
				<li class="span3">
				  ...
				  <i class="tag"></i>
					...
					<div class="caption">
					  <h5>Arduino Mega R3</h5>
					   <h4><a class="btn" href="product_details.php">VIEW</a> <span class="pull-right">$322.00</span></h4>
					</div>
				  </div>
				</li>
			  </ul>
			  ...
			  <ul class="thumbnails">
				<li class="span3">
				  ...
				  <i class="tag"></i>
					...
					<div class="caption">
					  <h5>6V DC Geared Motor</h5>
					  <h4><a class="btn" href="product_details.php">VIEW</a> <span class="pull-right">P122.00</span></h4>
					</div>
				  </div>
				</li>
				<li class="span3">
				...
				<li class="span3">
				  <div class="thumbnail">
					...
					<div class="caption">
					  ...
					  <h4 style="text-align:center"><a class="btn" href="product_details.php"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">P222.00</a></h4>
					</div>
				  </div>
				</li>
				<li class="span3">
