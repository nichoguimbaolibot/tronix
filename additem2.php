...
<div id="welcomeLine" class="row">
	...
	if(isset($_SESSION['name']))
  {
	...
	<div class="pull-right">
		...
		<span class="btn btn-mini">P155.00</span></a>
		<a href="product_summary.php"><span class="btn btn-mini btn-primary"><i class="icon-shopping-cart icon-white"></i> [ 3 ] Items in your cart </span> </a> 
...
<!-- Sidebar end=============================================== -->
	...
	<form class="form-horizontal"  action="upload.php" method="post">
		...
		<div class="controls">
  		...
  		<?php else if(isset($_SESSION['ptype']=="Electronic Components")): ?>
  			<select class="srchTxt" name="scope">
				<option value="">-</option>
  		...
  		<?php else if(isset($_SESSION['ptype']=="Automation Parts")): ?>
  			<select class="srchTxt" name="scope">
				<option value="">-</option>
  		...
  		<?php else (isset($_SESSION['ptype']=="Electrical Components")): ?>
  			<select class="srchTxt" name="scope">
				<option value="">-</option>
		...
		<?php else (isset($_SESSION['ptype']="Tools and Equipment")): ?>
  			<select class="srchTxt" name="scope">
				<option value="">-</option>
	...
	<div class="control-group">
			<div class="controls">
				...
				<input class="btn btn-large btn-success" type="submit" value="Next" name="send" />
			</div>
		</div>		
	</form>
</div>
